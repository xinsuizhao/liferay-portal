...
public class PropsValues {
	...
	public static final boolean DL_FILE_ENTRY_THUMBNAIL_LEGACY_GENERATION = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.DL_FILE_ENTRY_THUMBNAIL_LEGACY_GENERATION));
