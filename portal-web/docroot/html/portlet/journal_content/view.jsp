										...
										<liferay-ui:icon-list>
											...
											%>
												...
												<liferay-ui:icon
													...
													label="<%= true %>"
													message='<%= LanguageUtil.format(pageContext, "x-convert-x-to-x", new Object[] {"hide-accessible", HtmlUtil.escape(articleDisplay.getTitle()), StringUtil.toUpperCase(extension)}) %>'
													method="get"
